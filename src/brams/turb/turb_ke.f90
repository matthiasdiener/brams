...
subroutine mxtked(m1,m2,m3,ia,iz,ja,jz,ibcon,jd  &
   ...
   ,vt3dc,vt3dh,vt3dj,scr1,scr2,sflux_u,sflux_v,sflux_w,sflux_t,dxt,rtgt,lpw)
!  +-------------------------------------------------------------------+
...
subroutine tkemy(m1,m2,m3,ia,iz,ja,jz,ibcon,jd,i0,j0  &
   ...
   ,theta,dn0,up,vp,wp,sflux_u,sflux_v,sflux_w,sflux_t,tkep2,lpw,lpu,lpv)
