...
!LFR>                             modes7,                  & ! intent()                                                                  
!LFR>                             modes8,                  & ! intent()                                                                  
!LFR>                             set_intermodal_transfer, & ! intent()                                                                  
!LFR>                             write_log ,              & ! intent()                                                                    
!LFR>                             aunit1,                  & ! intent()                                                                  
!LFR>                             chem_spc_name,           & ! intent()                                                                  
...
!LFR>                             numb_ssa_1,              & ! intent()                                                                  
!LFR>                             mass_ssc_sulf,           & ! intent()                                                                  
!LFR>                             mass_ssc_seas,           & ! intent()                                                                  
!LFR>                             numb_ssc_1,              & ! intent()                                                                  
!LFR>                             mass_sss_sulf,           & ! intent()                                                                  
!LFR>                             mass_sss_seas,           & ! intent()                                                                  
!LFR>                             numb_sss_1,              & ! intent()                                                                  
!LFR>                             mass_occ_sulf,           & ! intent()                                                                  
!LFR>                             mass_occ_ocar ,          & ! intent()                                                                    
!LFR>                             numb_occ_1,              & ! intent()                                                                  
...
!LFR>                             mass_dbc_sulf,           & ! intent()                                                                  
!LFR>                             mass_dbc_bcar,           & ! intent()                                                                  
!LFR>                             mass_dbc_dust,           & ! intent()                                                                  
!LFR>                             numb_dbc_1,              & ! intent()                                                                  
!LFR>                             mass_boc_sulf,           & ! intent()                                                                  
!LFR>                             mass_boc_bcar,           & ! intent()                                                                  
!LFR>                             mass_boc_ocar,           & ! intent()                                                                  
!LFR>                             numb_boc_1,              & ! intent()                                                                  
!LFR>                             mass_bcs_sulf,           & ! intent()                                                                  
!LFR>                             mass_bcs_bcar,           & ! intent()                                                                  
!LFR>                             numb_bcs_1,              & ! intent()                                                                  
!LFR>                             mass_ocs_sulf,           & ! intent()                                                                  
!LFR>                             mass_ocs_ocar,           & ! intent()                                                                  
!LFR>                             numb_ocs_1,              & ! intent()                                                                  
!LFR>                             mass_mxx_sulf,           & ! intent()                                                                  
!LFR>                             mass_mxx_bcar,           & ! intent()                                                                  
!LFR>                             mass_mxx_ocar,           & ! intent()                                                                  
!LFR>                             mass_mxx_dust,           & ! intent()                                                                  
!LFR>                             mass_mxx_seas,           & ! intent()                                                                  
!LFR>                             numb_mxx_1,              & ! intent()                                                                     
!LFR>                             numb_akk_2,              & ! intent()                                                                  
!LFR>                             numb_acc_2,              & ! intent()                                                                  
!LFR>                             numb_dd1_2,              & ! intent()                                                                  
!LFR>                             numb_ds1_2,              & ! intent()                                                                  
!LFR>                             numb_dd2_2,              & ! intent()                                                                  
!LFR>                             numb_ds2_2,              & ! intent()                                                                  
!LFR>                             numb_ssa_2,              & ! intent()                                                                  
!LFR>                             numb_ssc_2,              & ! intent()                                                                  
!LFR>                             numb_sss_2,              & ! intent()                                                                  
!LFR>                             numb_occ_2,              & ! intent()                                                                  
!LFR>                             numb_bc1_2,              & ! intent()                                                                  
!LFR>                             numb_bc2_2,              & ! intent()                                                                  
!LFR>                             numb_bc3_2,              & ! intent()                                                                  
!LFR>                             numb_ocs_2,              & ! intent()                                                                  
!LFR>                             numb_dbc_2,              & ! intent()                                                                  
!LFR>                             numb_boc_2,              & ! intent()                                                                  
!LFR>                             numb_bcs_2,              & ! intent()                                                                  
!LFR>                             numb_mxx_2,              & ! intent()                                                                  
!LFR>                             dg_ssa_emis,             & ! intent()                                                                  
!LFR>                             sg_ssa_emis,             & ! intent()                                                                  
!LFR>                             dg_ssc_emis,             & ! intent()                                                                  
!LFR>                             sg_ssc_emis,             & ! intent()                                                                  
!LFR>                             dg_sss_emis,             & ! intent()                                                                  
!LFR>                             sg_sss_emis,             & ! intent()                                                                  
!LFR>                             activation_comparison,   & ! intent()                                                                  
!LFR>                             discrete_eval_option,    & ! intent()                                                                  
!LFR>                             densp,                   & ! intent()                                                                  
!LFR>                             pi6,                     & ! intent()                                                                     
!LFR>                             emis_dens_seas,          & ! intent()                                                                  
!LFR>                             zheight,                 & ! intent()                                                                  
!LFR>                             rgas_si,                 & ! intent()                                                                  
!LFR>                             pi,                      & ! intent()                                                                  
!LFR>                             mw_h2so4,                & ! intent()                                                                  
!LFR>                             emis_dens,               & ! intent()                                                                  
!LFR>                             dg_akk,                  & ! intent()                                                                  
!LFR>                             dg_acc,                  & ! intent()                                                                  
!LFR>                             dg_dd1,                  & ! intent()                                                                  
!LFR>                             dg_dd2,                  & ! intent()                                                                  
...
!LFR>                             sg_ocs,                  & ! intent()                                                                  
!LFR>                             sg_mxx,                  & ! intent()                                                                  
!LFR>                             dg_akk_emis,             & ! intent()                                                                  
!LFR>                             dg_acc_emis,             & ! intent()                                                                  
!LFR>                             dg_dd1_emis,             & ! intent()                                                                  
!LFR>                             dg_dd2_emis,             & ! intent()                                                                  
!LFR>                             dg_ds1_emis,             & ! intent()                                                                  
!LFR>                             dg_ds2_emis,             & ! intent()                                                                  
!LFR>                             dg_occ_emis,             & ! intent()                                                                  
!LFR>                             dg_bc1_emis,             & ! intent()                                                                  
!LFR>                             dg_bc2_emis,             & ! intent()                                                                  
!LFR>                             dg_bc3_emis,             & ! intent()                                                                  
!LFR>                             dg_dbc_emis,             & ! intent()                                                                  
!LFR>                             dg_boc_emis,             & ! intent()                                                                  
!LFR>                             dg_bcs_emis,             & ! intent()                                                                  
!LFR>                             dg_ocs_emis,             & ! intent()                                                                  
!LFR>                             dg_mxx_emis ,            & ! intent()                                                                    
!LFR>                             sg_akk_emis,             & ! intent()                                                                  
!LFR>                             sg_acc_emis,             & ! intent()                                                                  
!LFR>                             sg_dd1_emis,             & ! intent()                                                                  
!LFR>                             sg_dd2_emis,             & ! intent()                                                                  
!LFR>                             sg_ds1_emis,             & ! intent()                                                                  
!LFR>                             sg_ds2_emis,             & ! intent()                                                                  
!LFR>                             sg_occ_emis,             & ! intent()                                                                  
!LFR>                             sg_bc1_emis,             & ! intent()                                                                  
!LFR>                             sg_bc2_emis,             & ! intent()                                                                  
!LFR>                             sg_bc3_emis,             & ! intent()                                                                  
!LFR>                             sg_dbc_emis,             & ! intent()                                                                  
!LFR>                             sg_boc_emis,             & ! intent()                                                                  
!LFR>                             sg_bcs_emis,             & ! intent()                                                                  
!LFR>                             sg_ocs_emis,             & ! intent()                                                                  
!LFR>                             sg_mxx_emis,             & ! intent()                                                                  
!LFR>                             kappai_akk,              & ! intent()                                                                  
!LFR>                             kappai_acc,              & ! intent()                                                                  
!LFR>                             kappai_dd1,              & ! intent()                                                                  
!LFR>                             kappai_dd2,              & ! intent()                                                                  
!LFR>                             kappai_ds1,              & ! intent()                                                                  
!LFR>                             kappai_ds2,              & ! intent()                                                                  
!LFR>                             kappai_ssa,              & ! intent()                                                                  
!LFR>                             kappai_ssc,              & ! intent()                                                                  
!LFR>                             kappai_sss,              & ! intent()                                                                  
!LFR>                             kappai_occ,              & ! intent()                                                                  
!LFR>                             kappai_bc1,              & ! intent()                                                                  
!LFR>                             kappai_bc2,              & ! intent()                                                                  
!LFR>                             kappai_bc3,              & ! intent()                                                                  
!LFR>                             kappai_dbc,              & ! intent()                                                                  
!LFR>                             kappai_boc,              & ! intent()                                                                     
!LFR>                             kappai_bcs,              & ! intent()                                                                  
!LFR>                             kappai_ocs,              & ! intent()                                                                  
!LFR>                             kappai_mxx,              & ! intent()                                                                  
!LFR>                             emis_dens_sulf,          & ! intent()                                                                  
!LFR>                             emis_dens_dust,          & ! intent()                                                                  
!LFR>                             emis_dens_ocar,          & ! intent()                                                                  
!LFR>                             emis_dens_bcar,          & ! intent()                                                                  
!LFR>                             emis_dens_bocc,          & ! intent()                                                                  
!LFR>                             rho_nh42so4,             & ! intent()                                                                  
!LFR>                             rho_h2o,                 & ! intent()                                                                  
!LFR>                             prod_index_sulf,         & ! intent()                                                                  
!LFR>                             prod_index_bcar,         & ! intent()                                                                  
!LFR>                             prod_index_ocar,         & ! intent()                                                                  
!LFR>                             prod_index_dust,         & ! intent()                                                                  
!LFR>                             prod_index_seas,         & ! intent()                                                                     
!LFR>                             ngases,                  &! intent()
!LFR>                             citable1,                & !intent()
!LFR>                             citable2,                & !intent()
!LFR>                             citable3,                & !intent()
