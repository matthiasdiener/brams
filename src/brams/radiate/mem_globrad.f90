...
!!$    call fatal_error(h//"**(JP)** ISWRTYP==4 .or. ILWRTYP==4 not worked yet")
    ...
    call parf_bcast(caseE, int(size(caseE,1),i8), int(size(caseE,2),i8), &
         master_num)
    call parf_bcast(caseW, int(size(caseW,1),i8), int(size(caseW,2),i8), &
         master_num)
    call parf_bcast(caseG, int(size(caseG,1),i8), int(size(caseG,2),i8), &
         master_num)
