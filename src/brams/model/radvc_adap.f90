...
subroutine vel_advectc_adap(m1,m2,m3,ia,iz,ja,jz,izu,jzv,jdim,lpu,lpv,lpw  &
...
subroutine fa_xc_adap(m1,m2,m3,ia,iz,ja,jz,lpw  &
...
subroutine fa_yc_adap(m1,m2,m3,ia,iz,ja,jz,lpw  &
...
subroutine fa_zc_adap(m1,m2,m3,ia,iz,ja,jz,lpw  &
...
subroutine advtndc_adap(m1,m2,m3,ia,iz,ja,jz,lpw,scp,sca,sct,dtl,mynum)
