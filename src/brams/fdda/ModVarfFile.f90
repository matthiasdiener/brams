...
!!$     vpref=varpref
       ...
       do nf=1,nvarffiles
          ...
          if(flag .eq. 2)then
             ...
             call makefnam (sVarName, nud_hfile, 0, iyears, imonths, idates, ihours, 'A', 'head', 'txt')
...
!!$     PRINT*,'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!'
    ...
    elseif(initialFlag .eq. 4)then
       ...
       call Broadcast(ngrids1, master_num, 'ngrids1')
       ...
       call Broadcast(ioutput1, master_num,'ioutput1')
