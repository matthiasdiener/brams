ModVarfFile.o : $(FDDA)/ModVarfFile.f90\
	...
	isan_coms.o mem_grid.o ModGridTree.o ModGrid.o mem_chem1.o \
	mem_leaf.o mem_basic.o micphys.o chem1_list.o ModMessageSet.o \
...
ReadBcst.o : $(MPI)/ReadBcst.f90 mem_grid.o node_mod.o \
	...
	mem_globrad.o parlibf.o shcu_vars_const.o sib_vars.o \
	emission_source_map.o plumerise_vector.o domain_decomp.o \
...
sfclyr_jules.o : $(JULES)/sfclyr_jules.f90 mem_all.o extra.o leaf_coms.o rconstants.o mem_globaer.o \
...
catt_start.o : $(CATT)/catt_start.f90 ModNamelistFile.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
mem_basic.o : $(MEMORY)/mem_basic.f90 var_tables.o $(UTILS_INCS)/i8.h \
	mem_stilt.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
mem_scratch.o : $(MEMORY)/mem_scratch.f90 grid_dims.o \
	node_mod.o mem_aerad.o mem_radiate.o catt_start.o var_tables.o 
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
mem_tend.o : $(MEMORY)/mem_tend.f90 mem_basic.o mem_micro.o \
	mem_turb.o mem_scalar.o var_tables.o \
...
node_mod.o : $(MPI)/node_mod.f90 grid_dims.o mem_grid.o ModNamelistFile.o \
	ModParallelEnvironment.o ModGridTree.o ModDomainDecomp.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
sib_vars.o : $(SIB)/sib_vars.f90 ref_sounding.o ModNamelistFile.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
emission_source_map.o : $(CATT)/emission_source_map.f90 mem_basic.o \
	mem_grid.o mem_scalar.o extra.o mem_scratch.o error_mess.o parlibf.o \
	ModDateUtils.o ModNamelistFile.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
alloc.o : $(MEMORY)/alloc.f90 mem_all.o mem_opt_scratch.o mem_shcu.o \
	...
	teb_spm_start.o mem_teb.o mem_teb_common.o mem_gaspart.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 

rams_mem_alloc.o : $(MEMORY)/rams_mem_alloc.f90  catt_start.o ccatt_extra.o \
	...
	mem_scratch3_grell_sh.o mem_shcu.o mem_sib.o mem_sib_co2.o \
	mem_turb_scalar.o node_mod.o shcu_vars_const.o sib_vars.o \
	...
	chem1_list.o aer1_list.o chem1aq_list.o	ModDomainDecomp.o memMatrix.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
rtimh.o : $(MODEL)/rtimh.f90 mem_basic.o mem_cuparm.o \
	...
	mod_advect_kit.o machine_arq.o emission_source_map.o rad_driv.o cup_grell3.o digitalFilter.o\
	ChemSourcesDriver.o ChemDryDepDriver.o chemistry.o ModTimeStamp.o ModGrid.o raco.o \
        MatrixDriver.o memMatrix.o seasalt.o \
	ModMessageSet.o $(UTILS_INCS)/i8.h $(UTILS_INCS)/tsNames.h  
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 

ModOneProc.o : $(MODEL)/ModOneProc.f90 ModNamelistFile.o catt_start.o \
	...
	radvc_mnt.o plumerise_vector.o shcu_vars_const.o sib_vars.o \
	soilMoisture.o teb_spm_start.o mem_teb_vars_const.o var_tables.o \
	mem_varinit.o \
	emission_source_map.o grid_dims.o local_proc.o ModTimeStamp.o \
...
model.o : $(MODEL)/model.f90  catt_start.o io_params.o mem_grid.o \
...
rnode.o : $(MODEL)/rnode.f90  catt_start.o io_params.o mem_basic.o \
...
leaf3.o : $(SURFACE)/leaf3.f90  node_mod.o io_params.o leaf_coms.o mem_all.o \
	mem_turb.o mem_radiate.o micphys.o catt_start.o \
	ccatt_start.o \
...
sib2_driver.o : $(SIB)/sib2_driver.f90  leaf_coms.o mem_all.o \
	mem_basic.o mem_cuparm.o mem_micro.o mem_sib.o \
	mem_sib_co2.o rconstants.o ModDateUtils.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
vtab_fill.o : $(MEMORY)/vtab_fill.f90 io_params.o var_tables.o \
	mem_grid_dim_defs.o mem_grid.o $(UTILS_INCS)/i8.h
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 

ccatt_extra.o : $(CCATT)/ccatt_extra.f90 var_tables.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 

aer1_list.o : $(CCATT)/aer1_list.f90 
	cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
chem_plumerise_scalar.o : $(CCATT)/chem_plumerise_scalar.f90 mem_basic.o mem_grid.o ccatt_extra.o \
...
ChemSourcesDriver.o : $(CCATT)/ChemSourcesDriver.f90 chem1_list.o mem_chem1.o \
	...
	chem_sources.o mem_stilt.o memMatrix.o
	cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
ChemDryDepDriver.o : $(MODEL_CHEM)/ChemDryDepDriver.f90 rconstants.o mem_grid.o \
	...
	mem_radiate.o mem_chem1.o mem_aer1.o chem_dry_dep.o memMatrix.o
	cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
local_proc.o : $(MODEL)/local_proc.f90 mem_varinit.o mem_cuparm.o grid_dims.o \
	mem_grid.o catt_start.o rconstants.o ref_sounding.o io_params.o mem_stilt.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90)
...
rad_carma.o : $(RADIATE)/rad_carma.f90  mem_aerad.o mem_carma.o \
	...
	rrad3.o carma_fastjx.o mem_tuv.o	
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
opspec.o : $(IO)/opspec.f90  io_params.o mem_cuparm.o teb_spm_start.o \
	...
	ccatt_start.o chem_sources.o shcu_vars_const.o memMatrix.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
rad_driv.o : $(RADIATE)/rad_driv.f90  catt_start.o grid_dims.o \
	...
	teb_spm_start.o mem_teb_common.o ModUkmoAdapt.o Rad_UKMO.o \
	ModDateUtils.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
rconv_grell_catt.o : $(CUPARM)/rconv_grell_catt.f90  Phys_const.o \
	ccatt_extra.o io_params.o mem_basic.o mem_cuparm.o mem_grell.o \
	...
	$(UTILS_INCS)/tsNames.h  catt_start.o
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
module_cu_gd_fim.o : $(CUPARM)/module_cu_gd_fim.f90  
	cp -f $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
mem_stilt.o : $(STILT)/mem_stilt.f90 grid_dims.o mem_turb.o \
	ModNamelistFile.o rconstants.o
	cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
chemistry.o : $(CCATT)/chemistry.f90 mem_scalar.o mem_grid.o mem_all.o \
	...
	tuvParameter.o ModTuv2.7.o ModTuvDriver2.7.o memMatrix.o
	cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
radvc_mnt.o : $(MODEL)/radvc_mnt.f90  mem_basic.o mem_grid.o mem_scratch.o \
	var_tables.o node_mod.o micphys.o rconstants.o ccatt_extra.o \
...
MatrixDriver.o: $(MATRIX)/MatrixDriver.f90  subs.o diam.o \
	mem_basic.o mem_grid.o rconstants.o  ModParticle.o mem_aerosol.o memMatrix.o 
	cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
...
mem_aerosol.o: $(MEMORY)/mem_aerosol.f90  ModNamelistFile.o  setup.o \
        subs.o coag.o npf.o memMatrix.o
	cp -f  $< $(<F:.f90=.f90)
	$(F_COMMAND) $(<F:.f90=.f90)
	rm -f $(<F:.f90=.f90) 
